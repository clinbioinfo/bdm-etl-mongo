'''
  This loader will load each source file into a collection which will be named after the
  basename of the source file itself.  In other words, all ae.csv files will be loaded
  into a MongoDB collection called 'ae'.
